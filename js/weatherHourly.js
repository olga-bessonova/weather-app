...
export async function weatherHourly(weatherHourly, selectedDateStr, units) {
    ...
    for (let i of filteredIndices) {
        ...
        tempDiv.innerHTML = units.temperature === 'celsius' ? `${Math.round(temperature)}°C` : `${convertTemp(temperature)}°F`;
